/**
 * Main class to test IPod, IPad, IPhone, and IPhone16 classes.
 *
 * @author Prabh Qian Justin
 * @version 1.0
 */
public class Main {
    ...
    public static void main(final String[] args) {
        ...
        // Create IPod objects
        final IPod ipod1 = new IPod(300, 80.0); // 300 songs, max volume 80.0 dB
        final IPod ipod2 = new IPod(400, 85.0); // 400 songs, max volume 85.0 dB
        final IPod ipod3 = new IPod(300, 70.0); // 300 songs, max volume 70.0 dB
        ...
        // Create IPad objects
        final IPad ipad1 = new IPad(true, "iPadOS 15");  // Has case, OS version iPadOS 15
        final IPad ipad2 = new IPad(false, "iPadOS 14"); // No case, OS version iPadOS 14
        final IPad ipad3 = new IPad(true, "iPadOS 15");  // Has case, OS version iPadOS 15
        ...
        final IPhone iphone1 = new IPhone(120.0, "Verizon");  // 120 minutes, carrier Verizon
        final IPhone iphone2 = new IPhone(180.0, "T-Mobile"); // 180 minutes, carrier T-Mobile
        final IPhone iphone3 = new IPhone(120.0, "AT&T");     // 120 minutes, carrier AT&T
        ...
        final IPhone16 iphone16_1 = new IPhone16(
                100.0, "Verizon", true, 512); // 100 minutes, high-res camera, 512 GB

        final IPhone16 iphone16_2 = new IPhone16(
                100.0, "Verizon", true, 256); // 100 minutes, high-res camera, 256 GB

        final IPhone16 iphone16_3 = new IPhone16(
                100.0, "Verizon", false, 512); // 100 minutes, no high-res camera, 512 GB
